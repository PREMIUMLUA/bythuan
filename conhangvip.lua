loadstring(game:HttpGet("https://bitbucket.org/master98/1/raw/301c410fe316604016e4854c5f7a1b7c2db05b14/README.md"))()
...
function DisableTween(v0)
    if not v0 then
        NoClip = false
        topos(LP.Character.HumanoidRootPart.CFrame)
    end
end
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		if logo == nil then
			logo = "rbxassetid://116028320260198"
		end
		if delays == nil then
			delays = 1
		end
		...
		imagenoti.Image = "http://www.roblox.com/asset/?id=116028320260198"..tostring(logo)
	...
	DiscordLib:Notification("Thông Báo" , "Link discord Ở Phần Setting  1" , 6 ,11816162894 )
 ...
 local DiscordLib = {}
    ...
    function DiscordLib:Notification(titel,text,delays)
      ...
      imagenoti.Image = "rbxassetid://116028320260198"
 ...
 Logo.Image = "rbxassetid://116028320260198"..tostring(logo)
...
OkayBtn.MouseButton1Click:Connect(function()
 ...
 ImageLabel.Image = "rbxassetid://116028320260198"
...
spawn(function()
	pcall(function()
		game:GetService("RunService").Stepped:Connect(function()
		  	if _G.Auto_Farm_Level or _G.Auto_New_World or _G.tpkit or  _G.thuocsung or _G.sungtegiac or _G.candy or _G.shinapo or _G.chatpong or _G.rangnanh or  _G.magma or _G.Auto_Third_World or _G.duoica or _G.tocquy or _G.TeleportIsland or _G.SeaBeasts1 or _G.vayrong or _G.Auto_Farm_Boss or _G.Autotushita or _G.Auto_Elite_Hunter or _G.Auto_Cake_Prince or _G.Auto_Farm_All_Boss or _G.Auto_Saber or _G.Auto_Pole  or _G.Auto_Factory_Farm or _G.Auto_Farm_Ectoplasm or _G.mudautr or _G.Auto_Rengoku or _G.Auto_Farm_Radioactive or _G.Auto_Swan_Glasses or _G.Auto_Dragon_Trident or _G.Auto_Soul_Reaper  or _G.Auto_Farm_Bone or _G.canho or _G.Cacao  or _G.nuocmat or _G.Auto_Open_Dough_Dungeon or _G.Auto_Rainbow_Haki or _G.Auto_Musketeer_Hat or _G.Auto_Holy_Torch or _G.Auto_Canvander or _G.d or _G.Auto_Twin_Hook or _G.Auto_Serpent_Bow or _G.AutoFarmMaterial or _G.Auto_Fully_Death_Step or _G.Auto_Fully_SharkMan_Karate or _G.Teleport_to_Player or _G.Auto_Kill_Player_Melee or _G.Auto_Kill_Player_Gun or _G.Start_Tween_Island or _G.Auto_Next_Island or _G.autoraid or AutoNextIsland or _G.Auto_Farm_Sword or _G.MeleeFarm or _G.AutoFarmSelectMonster or _G.AutoFarmKenHakivor or _G.AutoObservationHakiV2  or _G.AutoFactory or _G.Auto_Kill_Law then
...
--------------------------------------------------------------------
local Library = Update:Window("Premium","")
------------------------------------------
...
local ca = Library:Tab("Sea Events","http://www.roblox.com/asset/?id=7044233235")
local Race = Library:Tab("tộc V4","rbxassetid://11447069304")
--local Stats = Library:Tab("Stats","rbxassetid://11447069304")
local P = Library:Tab("Player","rbxassetid://11446900930")
local Teleport = Library:Tab("dịch chuyển","rbxassetid://11446920523")
...
local Misc = Library:Tab("cài đặt2","rbxassetid://11447063791")
--local Op = Library:Tab("Status", "rbxassetid://7040410130")
local Setting = Library:Tab("cài đặt1","rbxassetid://11446835336")
--------------------------------------------------------------------
...
Setting:Button("Sao Chép Link discord",function()
 ...
 setclipboard("https://discord.gg/URhmM5MrAN")
...
function CheckAntiCheatBypass()
 ...
 Setting:Toggle("AntiBan",true,function(value)
        _G.AntiCheat = value
            CheckAntiCheatBypass()
        end)
...
local AttackList = {"Slow", "Normal", "Pro"}
_G.FastAttackDelay = "Normal"
Setting:Dropdown("Attack Delay",AttackList,function(value)
        _G.FastAttackDelay = value
  end)
Setting:Toggle("Slow Attack",true,function(value)
 _G.FastAttack = value
 if value then
     Attack1Function()
     end
...
Setting:Toggle("Tàn Hình Quái",false,function(value)
    _G.inv = value
...
Setting:Toggle("Remove Hiệu Ứng chết",true,function(value)
...
spawn(function()
    ...
    Setting:Toggle("Ẩn Gui",false,function(value)
        if value == true then
 ...
 Setting:Toggle("Fix lag nhẹ",nil,function(value)
...
spawn(function()
 ...
 ca:Button("Chỗ Mua Thuyền ( Update )",function()
...
ca:Button("Xóa Xương Mù",function()
...
ca:Seperator("Kitsune Island") 
local FullMoon = ca:Label("")
...
task.spawn(function()
 ...
 ca:Toggle("ESP Island Kitsune",false,function(value)
        IslandESP = value
...
ca:Toggle("Bay vào đảo Kitsune ", false, function(value)
    _G.tpkit = value
    StopTween(_G.tpkit)
end)
...
ca:Toggle("Nhặt Linh hồn", false, function(value)
    _G.lumlinhhon = value
    StopTween(_G.lumlinhhon)

    if _G.lumlinhhon then
        -- Bắt đầu vòng lặp nếu chức năng được bật
        spawn(function()
            while _G.lumlinhhon do
                ...
                if humanoidRootPart then
                    ...
                    while not partFound and humanoidRootPart:IsDescendantOf(workspace) do
                        ...
                        wait(0.1) -- Chờ 0.3 giây trước khi kiểm tra lại
                    end
                end
            end
        end)
...
ca:Button("Teleport Linh hồn",function()
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
   ...
   Setting:Button("Giảm Lag",function()
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Size = UDim2.new(0, 50, 0, 50)
		imagenoti.BackgroundTransparency = 1
		imagenoti.Image = "rbxassetid://116028320260198"..tostring(logo)
...
spawn(function()
    while wait() do
        pcall(function()
            BoneCheck:Set("Bones Đang Có : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candy","Check")))
        end)
    end
end)
...
if World3 then
	Main:Seperator("Candies Event")
local  candycheck  = Main:Label("Total")
spawn(function()
    while wait() do
        pcall(function()
            candycheck:Set("Candies Đang Có : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies","Check")))
        end)
    end
end)    
Main:Toggle("Farm kẹo ( New )",_G.candy,function(value)
 _G.candy = value
 _G.click = value
 StopTween(_G.candy)
end)
end
Main:Toggle("Đổi 100 candy Lấy 500 f",false,function(value)
  _G.buyitemevent1 = value
  if _G.buyitemevent1 == true then
  repeat wait()
if _G.buyitemevent1 then
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 2,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  ...
  until not _G.buyitemevent1
  end
  StopTween(_G.buyitemevent1)
 end) 
...
if v.Name == "Isle Outlaw" or v.Name == "Island Boy" or v.Name == "Sun-kissed Warrior" or v.Name == "Isle Champion" then
  ...
  game:GetService'VirtualUser':CaptureController()
  game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
  until _G.candy  or not v.Parent or v.Humanoid.Health &lt;= 0
  end
  end
  end
  else
topos(CFrame.new(-16560.2617, 201.446609, 413.246887, 0.96415323, 0.0126757724, 0.26504299, 2.80037057e-07, 0.998858213, -0.0477718264, -0.265345901, 0.0460594371, 0.963052511)) 
 for i,v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do 
                                if v.Name == "Isle Champion" then
...
local BossName = Main:Dropdown("Chọn Boss Farm", {}, function(value)
    _G.Select_Boss = value
end)

local refreshButton = Main:Button("Làm Mới Boss", function()
    BossName:Clear()
...
Weapon:Seperator(" Haki + Sea Beasts ")
...
Weapon:Toggle("Auto Đánh Boss + Đổi tộc Qủy",_G.tocquyautr,function(value)
 _G.tocquy = value
 _G.click = value
 _G.FastAttack = false
	...
	while task.wait() do
		pcall(function()
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
				mr:Set("🏝 Check Mirage : Có ✅")
			else
				mr:Set("🏝 Check Mirage : Không Có ❌")
			end
		end)
	end
end) 
...
Race:Toggle("Ông Bán Fruit Mirage",false,function(value)
    FindAdvancedDealer()
end)
...
Race:Toggle("Nhìn Trăng",false,function(value)
    _G.LockMoon = value
end)
...
Loop:Connect(function()
    if _G.LockMoon then
        game:GetService("Workspace").CurrentCamera.CFrame = CFrame.new(game:GetService("Workspace").CurrentCamera.CFrame.Position,game:GetService("Lighting"):GetMoonDirection() + game:GetService("Workspace").CurrentCamera.CFrame.Position)
    end
    if _G.mirage then
        if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
...
function fireremotechoosegear(bH)
   ...
   DiscordLib:Notification("Thông Báo" , "Chọn Gear Đi Bé" , 6 ,1181616289)
end
function InstantChooseGear()
    ...
    if v14 and v14.HadPoint then
        ...
        task.wait(300)
        	...
        	DiscordLib:Notification("Thông Báo" , "Chx up gear" , 6 ,1181616289)
        task.wait(30)
    end
end


Race:Toggle("Auto Gắn Gear",false,function(value)
 _G.gear = value
 StopTween( _G.gear)
end)
...
Race:Seperator("Buy + Bật Tộc") 
   ...
   Race:Toggle("Kill Người Chơi ( 90% Win )",_G.killplayertrain,function(value)
...
Race:Toggle("Tự Động Mua Train", false, function(value)
...
P:Slider("Kick Thước Vòng Aim",1,1000,200,function(value)
 _G.Select_Size_Fov = value
end)
P:Toggle("Hiện Vòng",_G.Show_Fov,function(value)
 _G.Show_Fov = value and _G.Select_Size_Fov == 200
StopTween(_G.Show_Fov)
end)
 
P:Toggle("Aim Skill Trong Vòng",_G.Aimbot_Skill_Fov,function(value)
...
StopTween(_G.Aimbot_Skill_Fov)
 ...
 Teleport:Toggle("Teleport",false,function(value)
  ...
  repeat wait()
  if _G.SelectIsland == "Đảo Hải Tặc" then
  topos(CFrame.new(979.79895019531, 16.516613006592, 1429.0466308594))
  elseif _G.SelectIsland == "Đảo Hải Quân" then
  topos(CFrame.new(-2566.4296875, 6.8556680679321, 2045.2561035156))
  elseif _G.SelectIsland == "Đảo Trung Tâm" then
  topos(CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094))
  elseif _G.SelectIsland == "Rừng" then
  topos(CFrame.new(-1612.7957763672, 36.852081298828, 149.12843322754))
  elseif _G.SelectIsland == "Đảo Chúa Hề" then
  topos(CFrame.new(-1181.3093261719, 4.7514905929565, 3803.5456542969))
  elseif _G.SelectIsland == "Đảo Xa Mạc" then
  topos(CFrame.new(944.15789794922, 20.919729232788, 4373.3002929688))
  elseif _G.SelectIsland == "Đảo Tuyết" then
  topos(CFrame.new(1347.8067626953, 104.66806030273, -1319.7370605469))
  elseif _G.SelectIsland == "Căng Cứ Hải Quân" then
  ...
  elseif _G.SelectIsland == "Nhà Ngục" then
  topos(CFrame.new(4875.330078125, 5.6519818305969, 734.85021972656))
  elseif _G.SelectIsland == "Đảo Dung Nham" then
  topos(CFrame.new(-5247.7163085938, 12.883934020996, 8504.96875))
  elseif _G.SelectIsland == "Đảo Người Cá" then
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
  elseif _G.SelectIsland == "Đảo Frency" then
  topos(CFrame.new(5127.1284179688, 59.501365661621, 4105.4458007813))
  elseif _G.SelectIsland == "Chỗ Shank Cụt Cay" then
  topos(CFrame.new(-1442.16553, 29.8788261, -28.3547478))
  elseif _G.SelectIsland == "Đảo Nv Saber" then
  topos(CFrame.new(-2850.20068, 7.39224768, 5354.99268))
  elseif _G.SelectIsland == "Cà phê" then
  topos(CFrame.new(-380.47927856445, 77.220390319824, 255.82550048828))
  elseif _G.SelectIsland == "Đảo Đầu Tiên" then
  topos(CFrame.new(-11.311455726624, 29.276733398438, 2771.5224609375))
  elseif _G.SelectIsland == "Đảo Râu Đen" then
  topos(CFrame.new(3780.0302734375, 22.652164459229, -3498.5859375))
  elseif _G.SelectIsland == "Cổng Vào Flamingo" then
  ...
  elseif _G.SelectIsland == "Đấu trường" then
  topos(CFrame.new(-1503.6224365234, 219.7956237793, 1369.3101806641))
  elseif _G.SelectIsland == "Đảo Zombie" then
  topos(CFrame.new(-5622.033203125, 492.19604492188, -781.78552246094))
  elseif _G.SelectIsland == "Núi Tuyết" then
  topos(CFrame.new(753.14288330078, 408.23559570313, -5274.6147460938))
  elseif _G.SelectIsland == "Đảo Raid" then
  ...
  elseif _G.SelectIsland == "Đảo cuối Sea2" then
  topos(CFrame.new(-3032.7641601563, 317.89672851563, -10075.373046875))
  elseif _G.SelectIsland == "Đảo Usopp" then
  topos(CFrame.new(4816.8618164063, 8.4599885940552, 2863.8195800781))
  elseif _G.SelectIsland == "Đảo Lấy Gậy Lôi v2" then
  topos(CFrame.new(-288.74060058594, 49326.31640625, -35248.59375))
  elseif _G.SelectIsland == "Cây đại thụ" then
  topos(CFrame.new(2681.2736816406, 1682.8092041016, -7190.9853515625))
  elseif _G.SelectIsland == "Pháo Đài Biển" then
  ...
  elseif _G.SelectIsland == "Cảng" then
  topos(CFrame.new(-290.7376708984375, 6.729952812194824, 5343.5537109375))
  elseif _G.SelectIsland == "Đảo Phụ Nữ" then
  topos(CFrame.new(5228.8842773438, 604.23400878906, 345.0400390625))
  elseif _G.SelectIsland == "Dinh Thự ( Đảo Rùa )" then
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12471.169921875, 374.94024658203, -7551.677734375))
  elseif _G.SelectIsland == "Đảo Xương" then
...
Teleport:Seperator(" Sever ")
Teleport:Button("Vô Lại Sever",function()
 local ts = game:GetService("TeleportService")
		local p = game:GetService("Players").LocalPlayer
		ts:Teleport(game.PlaceId, p)
end)

Teleport:Button("Đổi Sever",function()
 hop()
end)
    Teleport:Button("Đổi Sever ít Người",function()
...
Dungeon:Toggle("Start + kill + Qua Đảo",_G.Auto_StartRaid,function(value)
...
Dungeon:Toggle("Treo Tiền F",_G.Autofruit,function(value)
 _G.Autofruit = value
 _G.Kill_Aura = value
 _G.Auto_Next_Island = value
 _G.Auto_Buy_Chips_Dungeon = value
...
Shop:Dropdown("Chọn Item Buy",{
  "Mũ yêu tinh ( 250 Candies )",
  "Mũ santa ( 500 Candies )",
  "Xe trượt tuyết ( 1000 Candies )"
 },function(value)
  _G.buyitem = value
 end)
 ...
 Shop:Toggle("Mua Item Giáng sinh",false,function(value)
  ...
  repeat wait()
  if _G.buyitem == "Mũ yêu tinh ( 250 Candies )" then
  local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 3,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  elseif _G.buyitem == "Mũ santa ( 500 Candies )" then
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 3,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  elseif _G.buyitem == "Xe trượt tuyết ( 1000 Candies )" then
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 3,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  ...
  until not _G.buyitem
  end
  StopTween(_G.buyitem)
 end)
  
  
   Shop:Button("X2 EXP ( 50 Candies )",function()
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 1,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
   ...
   Shop:Button("Hoàn chỉ số ( 75 Candies )",function()
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 1,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
     ...
     Shop:Button("Thay đổi chủng tộc ( 100 Candies )",function()
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 1,
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
 ...
 Shop:Button("Mua Tộc Qủy",function()
local args = {
    [1] = "Ectoplasm",
    [2] = "BuyCheck",
    [3] = 4
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
 ...
 Shop:Button("Mua Tộc Máy",function()
local args = {
    [1] = "CyborgTrainer",
    [2] = "Check"
}
...
pcall(function() 
    game:GetService("Players").LocalPlayer.PlayerGui.Main.Energy.Visible = false
    --game:GetService("Players").LocalPlayer.PlayerGuain.Energy:Destroy()
end)
for k,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main:GetChildren()) do 
    if v:IsA("ImageButton") then 
        v.Visible = false
...
if  game.Players.LocalPlayer.Name == "JayceGuys019" or  game.Players.LocalPlayer.Name == "TamZau" then
DiscordLib:Notification("Thông Báo" , "Chào Bạn, Mình Là Admin Bản Premium Hub" , 6 ,11816162894)
    DiscordLib:Notification("Thông Báo" , "Cảm Ơn Bạn Đã Sử Dụng PREMIUM Hub" , 8,11816162894)
